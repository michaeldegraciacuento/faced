...
class FamilyPolicy
{
    ...
    {
        return $user->checkPermissionTo('delete-any Family');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any Family');
    }
    ...
    {
        return $user->checkPermissionTo('replicate Family');
    }
    ...
    {
        return $user->checkPermissionTo('reorder Family');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any Family');
    }
}
