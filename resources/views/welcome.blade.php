        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    <div>
                        @if (Auth::check())
                        <a href="{{ URL::to('admin') }}" style="position:absolute; top:10px; right:10px;">Dashboard</a>
                        @else
                        {{-- If not authenticated, show the login link --}}
                        <a href="{{ URL::to('admin/login') }}" style="position:absolute; top:10px; right:10px;">Login</a>
                        @endif
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            The Municipal Disaster Risk Reduction and Management Office (MDDRMO) of Gitagum is dedicated to ensuring the safety and well-being of the community through disaster preparedness, response, and recovery. We work closely with local authorities, organizations, and residents to build a disaster-resilient Gitagum
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Videos</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Explore our informative videos on disaster preparedness, safety protocols, and past response efforts. These videos are aimed at raising awareness and keeping the public informed.
                                </p>
                            </div>
                        ...
                        <a
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">News & Updates</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Stay up-to-date with the latest news on disaster management, upcoming drills, warnings, and other important announcements related to public safety in Gitagum.
                                </p>
                            </div>
                        ...
                        <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Contact Information</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    For inquiries or assistance, please reach out to the MDDRMO Gitagum:
                                    <br><br>
                                    <b>Email:</b> mdrrmc.gitagum@gmail.com <br>
                                    <b>Address:</b> Gitagum, Misamis Oriental <br>
                                    <b> MDRRMO HOTLINE:</b> 0975 840 3809 / 0981 136 8638 <br>
                                    <b>PNP HOTLINE:</b> 0998 598 6952 <br>
                                    <b>BFP HOTLINE:</b> 0966 994 9840
                                </p>
                            </div>
                        </div>
                    </div>
